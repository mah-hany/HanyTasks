...
router.put('/:id',                    authorizeLevel(3), taskController.update);
router.put('/:id/archive',            authorizeLevel(3), taskController.archive);
...
router.delete('/:id',                 authorizeLevel(3), taskController.delete);
